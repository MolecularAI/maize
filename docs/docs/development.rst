...
Type hints should only be omitted when either mypy or typing doesn't yet fully support the required feature, such as `higher-kinded types <https://github.com/python/typing/issues/548>`_ or type-tuples (:pep:`646`).
