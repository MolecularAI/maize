...
class Test_Node:
    ...
    def test_execute(self, node_with_channel):
        ...
        time.sleep(0.5)
        updates = []
        while not node_with_channel.message_queue.empty():
            updates.append(node_with_channel.message_queue.get())
        summary = updates[-1]
    ...
    def test_execute_run_fail(self, node_with_run_fail):
        ...
        time.sleep(0.5)
        updates = []
        while not node_with_run_fail.message_queue.empty():
            updates.append(node_with_run_fail.message_queue.get())
        summary = updates[-1]
        assert isinstance(updates[-2], TracebackException)
    ...
    def test_execute_run_int(self, node_with_run_int):
        ...
        time.sleep(0.5)
        updates = []
        while not node_with_run_int.message_queue.empty():
            updates.append(node_with_run_int.message_queue.get())
        summary = updates[-1]
    ...
    def test_execute_run_fail_2_attempts(self, node_with_run_fail_first):
        ...
        time.sleep(0.5)
        updates = []
        while not node_with_run_fail_first.message_queue.empty():
            updates.append(node_with_run_fail_first.message_queue.get())
        summary = updates[-1]
