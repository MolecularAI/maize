...
class MultiParameter(Parameter[T]):
    ...
    def __init__(
        self, parameters: Sequence[Parameter[T] | "Input[T]"], default: T | None = None
    ) -> None:
...
U = TypeVar("U", Any, Path)


# This is required to type this minor specialization when setting paths
def _make_abs(val: U) -> U:
    """Make a path absolute, if it's a path"""
